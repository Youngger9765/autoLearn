...
## Roadmap：AI 生成型課程 Marketplace 發展路線

### 1. 課程上架與公開分享
- [ ] 課程上架/公開機制：產生課程後可一鍵上架，讓其他人能搜尋、學習、收藏
- [ ] 課程詳情頁：獨立頁面顯示大綱、章節、作者、評價、收藏數
- [ ] 課程分類/標籤/搜尋：多維度分類、標籤、關鍵字搜尋

### 2. 創作者（老師）功能
- [ ] 老師個人頁/課程牆：展示老師所有上架課程、分類、簡介、粉絲數
- [ ] 自訂課程分類/主題包：老師可組織課程、建立系列課程
- [ ] 課程後台分析：瀏覽數、收藏數、學習人數、互動紀錄、學生回饋
- [ ] 課程管理/編輯/下架：老師可隨時管理自己的課程

### 3. 學習者功能
- [ ] 課程推薦系統：根據學習歷程、興趣、熱門度，AI 推薦課程
- [ ] 課程收藏/追蹤/學習進度：學生可收藏課程、追蹤進度、收到更新通知
- [ ] AI 自創課程入口：學生也能用 AI 產生專屬課程，並選擇是否公開
- [ ] 學習歷程可視化：進度條、成就徽章、錯題本、學習日誌

### 4. 社群與互動
- [ ] 課程留言/問答/評價：課程下方可留言、提問、評分，促進互動
- [ ] 排行榜/推薦牆：熱門課程、最新上架、評分最高等榜單
- [ ] 社群舉報/審核機制：確保內容品質與安全

### 5. 商業化與平台管理（進階）
- [ ] 課程付費/分潤/訂閱：老師可設計付費課程，平台可分潤
- [ ] 用戶分級/權限控管：老師、學生、管理員不同權限
- [ ] API/外部匯入/匯出：支援與其他平台串接

### 6. 技術與架構
- [ ] 資料庫 schema 擴充：課程、用戶、分類、收藏、評價、學習紀錄等資料表
- [ ] 推薦系統/搜尋引擎：AI/規則混合推薦、全文檢索
- [ ] 內容審核/敏感詞檢查：AI+社群雙重把關

### 7. UI/UX
- [ ] 課程牆/marketplace 首頁：可瀏覽、搜尋、篩選所有公開課程
- [ ] 個人頁/創作者頁：展示個人課程、收藏、成就
- [ ] 課程詳情/學習頁：章節展開、互動練習、AI 助教、留言區

---

**優先建議：**
1. 先做「課程上架/公開/搜尋/收藏」與「課程詳情頁」
2. 再做「創作者頁/個人頁/課程管理」
3. 逐步導入推薦、排行榜、社群互動、商業化等功能
